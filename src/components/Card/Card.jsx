...
function Card({ task, onOpenBrowse }) {
    ...
    <div className="cards__item">
      <div className="cards__card card">
        <div className="card__group">
          <div className={`card__theme ${getThemeClass(task.category)}`}>
            <p className={getThemeClass(task.category)}>{task.category}</p>
          </div>
          <a href="#popBrowse" target="_self" onClick={handleClick}>
